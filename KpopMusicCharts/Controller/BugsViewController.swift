...
class BugsViewController: UIViewController {
    @IBOutlet weak var bugsTableView: UITableView!
    var songs : [Song] = []
    ...
    private func setupTablewView() {
        bugsTableView.delegate = self
        bugsTableView.dataSource = self
        bugsTableView.register(UINib(nibName: "SongTableViewCell", bundle: nil), forCellReuseIdentifier: "songCell")
        bugsTableView.register(UINib(nibName: "EventBannerTableViewCell", bundle: nil), forCellReuseIdentifier: "EventBannerTableViewCell")
        let headerNib = UINib.init(nibName: "MainHeader", bundle: Bundle.main)
        bugsTableView.register(headerNib, forHeaderFooterViewReuseIdentifier: "MainHeader")
    }
